...
import { BarChart3, LayoutDashboard, PiggyBank, Receipt, Settings, Wallet, X } from "lucide-react";
import { cn } from "../../utils/cn.js";

const navItems = [
    { label: "Dashboard", icon: LayoutDashboard, to: "/dashboard", badge: null, end: true },
    { label: "Accounts", icon: Wallet, to: "/accounts", badge: "4" },
    { label: "Budgets", icon: PiggyBank, to: "/budgets", badge: null },
    { label: "Transactions", icon: Receipt, to: "/transactions", badge: "12" },
    { label: "Reports", icon: BarChart3, to: "/reports", badge: null },
...
const Sidebar = ({ isOpen, onClose }) => {
    return (
        <>
            {isOpen ? (
                <div
                    className="fixed inset-0 z-40 bg-neutral-900/50 backdrop-blur-sm opacity-100 transition-opacity md:hidden"
                    onClick={onClose}
                    aria-hidden
                />
            ) : null}
