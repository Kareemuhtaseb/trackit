...
import StatsGrid from './react/components/dashboard/StatsGrid.jsx';
import BalanceTrendChart from './react/components/charts/BalanceTrendChart.jsx';
import ExpenseBreakdownChart from './react/components/charts/ExpenseBreakdownChart.jsx';
import TransactionsTable from './react/components/table/TransactionsTable.jsx';
import Card from './react/components/ui/Card.jsx';
                        ...
                        <Card>
                            ...
                            <ul className="mt-5 space-y-4">
                                {scheduledPayments.map((payment) => (
                                    <li key={payment.title} className="rounded-lg border border-neutral-200/70 px-4 py-3 text-sm transition hover:border-primary-200 dark:border-neutral-700 dark:hover:border-neutral-600">
