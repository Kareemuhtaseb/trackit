<template>
    <div class="mx-auto max-w-3xl space-y-6">
        <div>
            <h1 class="text-2xl font-semibold text-slate-900">New transaction</h1>
            <p class="text-sm text-slate-500">Log a new debit or credit.</p>
        </div>
        ...
        <form class="space-y-4 rounded-lg bg-white p-6 shadow" @submit.prevent="submit">
            ...
            <div class="flex items-center gap-3">
                ...
                <router-link to="/transactions" class="text-sm font-medium text-slate-600 hover:text-slate-800">
                    Cancel
                </router-link>
            </div>
        </form>
